...
function SocialLink({
  ...
  return (
    <li className={clsx(className, 'flex')}>
      <Link
        href={href}
        className="group flex text-sm font-medium text-zinc-800 transition hover:text-orange-900 dark:text-zinc-200 dark:hover:text-orange-200"
      >
        <Icon className="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-orange-900 dark:group-hover:fill-orange-200" />
